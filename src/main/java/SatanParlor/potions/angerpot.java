package SatanParlor.potions;

import SatanParlor.powers.LoseVengeance;
...
public class angerpot extends AbstractPotion {


    public static final String POTION_ID = SatanParlor.DefaultMod.makeID("angerpot");
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, AbstractDungeon.player, new Vengeance(target, target, potency), potency));
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, AbstractDungeon.player, new LoseVengeance(target, target, potency), potency));
        }
    }
